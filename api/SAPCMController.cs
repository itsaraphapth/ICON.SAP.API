    ...
    public class SAPCMController : ApiController
    {
        ...
        public object CMCreateGoodsReceiptPO(dynamic Data)
        {
            ...
            try
            {
                ...
                string sql = GetSqlCMHeader(refid, tableName, "po_reccode", company_value);
                MySqlDataAdapter da = default(MySqlDataAdapter);
                        ...
                        foreach (DataRow dr in PostData.Rows)
                        {
                            ...
                            try
                            {
                                string DocNum = CreateCMGoodReceiptPO(new
                                {
                                    ...
                                    disprcnt  = dr["disprcnt"].ToString(),
                                    rounding  = dr["rounding"].ToString(),
                                    rounddif  = dr["rounddif"].ToString(),
                                    paytocode = dr["paytocode"].ToString(),
        ...
        public object CMCancelGoodsReceiptPO(dynamic Data)
        {
            ...
            try
            {
                string sql = GetSqlCMHeader(refid, "grch", "po_reccode", company_value);
        ...
        public object CMCancelGoodsReceiptPO_Service(dynamic Data)
        {
            ...
            try
            {
                string sql = GetSqlCMHeader(refid, "sc_h", "po_reccode", company_value);
                MySqlDataAdapter da = new MySqlDataAdapter();
                System.Data.DataTable PostData = new System.Data.DataTable();
                da = new MySqlDataAdapter(sql, conn);
                da.Fill(PostData);
        ...
        /// <returns></returns>
        [HttpPost]
        [Route("api/cm/inventorytransfer")]
        [AllowAnonymous]
        public object CMInventoryTransfer(dynamic Data)
        {
            MySqlConnection conn = new MySqlConnection(mySQLConn);
            conn.Open();
            List<string> ResultSuccess = new List<string>();
            ...
            string refid = "";
            string tableName = "tr_h";
            if (!string.IsNullOrEmpty((string)Data.transfer_code))
            {
                refid = (string)Data.transfer_code;
            }
            else
            {
                return new { status = false, message = "error", result = "transfer_code is require" };
            }
            ...
            try
            {
                ...
                string sql = GetSqlCMHeader(refid, tableName, "transfer_code", company_value);
                MySqlDataAdapter da = default(MySqlDataAdapter);
                System.Data.DataTable PostData = new System.Data.DataTable();
                da = new MySqlDataAdapter(sql, conn);
                da.Fill(PostData);
                ...
                if (PostData.Rows.Count > 0)
                {
                    try
                    {
                        foreach (DataRow dr in PostData.Rows)
                        {
                            ...
                            try
                            {
                                string DocNum = CreateCMInventoryTransfer(new
                                {
                                    transfer_code = dr["transfer_code"].ToString(),
                                    docdate = string.IsNullOrEmpty(dr["porecdate"].ToString()) || dr["porecdate"].ToString() == "0/0/0000" ? DateTime.Now : dr["porecdate"],
                                    duedate = string.IsNullOrEmpty(dr["date_transfer"].ToString()) || dr["date_transfer"].ToString() == "0/0/0000" ? DateTime.Now : dr["date_transfer"],
                                    taxdate = string.IsNullOrEmpty(dr["date_transfer"].ToString()) || dr["date_transfer"].ToString() == "0/0/0000" ? DateTime.Now : dr["date_transfer"],
                                    wh_from = dr["wh_from"].ToString(),
                                    wh_to = dr["wh_to"].ToString(),
                                    remark = dr["remark"].ToString(),
                                    address_transfer = dr["address_transfer"].ToString(),
                                    module = "CMInventoryTransfer",
                                    methodName = "CMInventoryTransfer",
                                    refDescription = "tr_h.transfer_code",
                                    tableName = tableName,
                                    company_value = dr["company_value"].ToString(),
                                });
                                ResultSuccess.Add(DocNum);
                            ...
                            {
                                ResultError.Add(dr["transfer_code"].ToString() + " : " + ex.Message);
                            }
                        }
        ...
        /// <returns></returns>
        [HttpPost]
        [Route("api/cm/cancelinventorytransfer")]
        [AllowAnonymous]
        public object CMCancelInventoryTransfer(dynamic Data)
        {
            MySqlConnection conn = new MySqlConnection(mySQLConn);
            conn.Open();
            List<string> ResultSuccess = new List<string>();
        ...
        public object CMCreateGoodsIssue(dynamic Data)
        {
            ...
            try
            {
                string sql = GetSqlCMHeader(refid, tableName, refName, company_value);
                MySqlDataAdapter da = default(MySqlDataAdapter);
                System.Data.DataTable PostData = new System.Data.DataTable();
                da = new MySqlDataAdapter(sql, conn);
                da.Fill(PostData);
        ...
        public object CMCreateGoodsReturn(dynamic Data)
        {
            ...
            try
            {
                string sql = GetSqlCMHeader(refid, "grth", "po_reccode", company_value);
                MySqlDataAdapter da = default(MySqlDataAdapter);
                System.Data.DataTable PostData = new System.Data.DataTable();
                da = new MySqlDataAdapter(sql, conn);
                da.Fill(PostData);
        ...
        public object CMCreateJournalVoucher(dynamic Data)
        {
            ...
            try
            {
                string sql = GetSqlCMHeader(refid, "pcadvh", "docno", company_value);
                MySqlDataAdapter da = default(MySqlDataAdapter);
                System.Data.DataTable PostData = new System.Data.DataTable();
                da = new MySqlDataAdapter(sql, conn);
                da.Fill(PostData);
                        ...
                        foreach (System.Data.DataRow dr in PostData.Rows)
                        {
                            try
                            {
                                string docNum = CreateJournalVoucher(new
                                {
                                    ...
                                    project_code = dr["project"].ToString(),
                                    ...
                                    company_value = dr["company_value"].ToString(),
                                    ref1 = dr["Ref1"].ToString(),
                                    ref2 = dr["Ref2"].ToString(),
                                    ref3 = dr["Ref3"].ToString(),
                                });
        ...
        public object CMSendGVAllocate(dynamic Data)
        {
            ...
            try
            {
                string sql = GetSqlCMHeader(refid, "pas_h", "Transld", company_value);
                MySqlDataAdapter da = default(MySqlDataAdapter);
                System.Data.DataTable PostData = new System.Data.DataTable();
                da = new MySqlDataAdapter(sql, conn);
                da.Fill(PostData);
                            ...
                            if (cnt == 0)
                            {
                                try
                                {
                                    string docNum = CreateUpdateCostCenter(new
                                    {
                                        ...
                                        valid_to = string.IsNullOrEmpty(dr["valid_to"].ToString()) || dr["valid_to"].ToString() == "0/0/0000" ? DateTime.MinValue : dr["valid_to"],
                            ...
                            if (cnt == 0)
                            {
                                try
                                {
                                    string docNum = CreateUpdateProject(new
                                    {
                                        ...
                                        project_stop = string.IsNullOrEmpty(dr["project_stop"].ToString()) || dr["project_stop"].ToString() == "0/0/0000" ? DateTime.MinValue : dr["project_stop"],
                    ...
                    try
                    {
                        ...
                        foreach (System.Data.DataRow dr in PostData.Rows)
                        {
                            if (cnt == 0)
                            {
                                try
                                {
                                    docNum = CreateUpdatePaymentTerms(new
                                    {
                            ...
                            if (cnt == 0)
                            {
                                try
                                {
                                    string docNum = CreateUpdateWarehouse(new
                                    {
                                        ...
                                        acct_inventoty = dr["acct_inventoty"].ToString(),
                                        acct_cost_of_good_sold = dr["acct_cost_of_good_sold"].ToString(),
                                        acct_allocation = dr["acct_allocation"].ToString(),
                                        acct_price_dif = dr["acct_price_dif"].ToString(),
                                        acct_expense = dr["acct_expense"].ToString(),
                                        acct_purchase_credit = dr["acct_purchase_credit"].ToString(),
                                        acct_revenue = dr["acct_revenue"].ToString(),
                                        acct_sales_credit = dr["acct_sales_credit"].ToString(),
                                        acct_increase = dr["acct_increase"].ToString(),
                                        acct_decrease = dr["acct_decrease"].ToString(),
                                        company_value = company_value
                                    });
        ...
        /// <summary>
        /// CM Create Update Item To Warehouse
        /// </summary>
        /// <returns></returns>
        [HttpPost]
        [Route("api/cm/createupdateitemtowarehouse")]
        [AllowAnonymous]
        public object CMCreateUpdateItemToWarehouse(dynamic Data)
        {
            MySqlConnection conn = new MySqlConnection(mySQLConn);
            conn.Open();
            List<string> ResultError = new List<string>();
            ...
            string refid = "";
            if (!string.IsNullOrEmpty((string)Data.item_code))
            {
                refid = (string)Data.item_code;
            }
            else
            {
                //throw new Exception( "docno is require" );
                return new { status = false, message = "error", result = "item code is require" };
            }
            string company_value = "";
            if (!string.IsNullOrEmpty((string)Data.company_value))
            {
            ...
            try
            {
                string sql = GetSqlCMHeader(refid, "item_wh", "item_code", company_value);
                MySqlDataAdapter da = default(MySqlDataAdapter);
                System.Data.DataTable PostData = new System.Data.DataTable();
                da = new MySqlDataAdapter(sql, conn);
                da.Fill(PostData);
                ...
                if (PostData.Rows.Count > 0)
                {
                    ...
                    try
                    {
                        ...
                        foreach (System.Data.DataRow dr in PostData.Rows)
                        {
                            ...
                            try
                            {
                                string docNum = CreateUpdateItemToWarehose(new
                                {
                            ...
                            {
                                ResultError.Add(dr["item_code"].ToString() + " : " + ex.Message);
                            }
                            cnt++;
                            //}
                        }
                            ...
                            if (cnt == 0)
                            {
                                try
                                {
                                    string docNum = CreateUpdateBusinessPartner(new
                                    {
                                        ...
                                        vender_name = dr["vender_name"].ToString(),
                                        cardfnme = dr["cardfnme"].ToString(),
                                        vender_type = dr["vender_type"].ToString(),
                                        cmpprivate = dr["cmpprivate"].ToString(),
                                        groupcode = dr["groupcode"].ToString(),
                                        currency =dr["currency"].ToString(),
                                        vender_tax = dr["vender_tax"].ToString(),
                                        remarks = dr["remarks"].ToString(),
                                        vender_tel = dr["vender_tel"].ToString(),
                                        vender_tel2 = dr["vender_tel2"].ToString(),
                                        vender_fax = dr["vender_fax"].ToString(),
                                        e_mail = dr["e_mail"].ToString(),
                                        website = dr["website"].ToString(),
                                        alias_name = dr["alias_name"].ToString(),
                                        cntct_prsn = dr["cntct_prsn"].ToString(),
                                        territory = dr["territory"].ToString(),
                                        glbl_loc_num = dr["glbl_loc_num"].ToString(),
                                        valid_for = dr["valid_for"].ToString(),
                                        frozen_for = dr["frozen_for"].ToString(),
                                        payment_id = dr["payment_id"].ToString(),
                                        payment_discount = dr["payment_discount"].ToString(),
                                        ar_payable = dr["ar_payable"].ToString(),
                                        vat_status = dr["vat_status"].ToString(),
                                        tax_group = dr["tax_group"].ToString(),
                                        wt_liable = dr["wt_liable"].ToString(),
                                        typwt_reprt = dr["typwt_reprt"].ToString(),
                                        company_value = company_value
                                    });
        ...
        public object CMCreateUpdateContactPersons(dynamic Data)
        {
            ...
            string refid = "";
            if (!string.IsNullOrEmpty((string)Data.bp_code))
            {
                refid = (string)Data.bp_code;
            }
            else
            {
                //throw new Exception( "docno is require" );
                return new { status = false, message = "error", result = "bp code is require" };
            }
            string company_value = "";
            if (!string.IsNullOrEmpty((string)Data.company_value))
            {
            ...
            try
            {
                string sql = GetSqlCMHeader(refid, "contact", "bp_code", company_value);
                MySqlDataAdapter da = default(MySqlDataAdapter);
                System.Data.DataTable PostData = new System.Data.DataTable();
                da = new MySqlDataAdapter(sql, conn);
                da.Fill(PostData);
                ...
                if (PostData.Rows.Count > 0)
                {
                    ...
                    try
                    {
                        ...
                        foreach (System.Data.DataRow dr in PostData.Rows)
                        {
                            ...
                            try
                            {
                                string docNum = CreateUpdateBusinessContactPersons(new
                                {
                                    bp_code = dr["bp_code"].ToString(),
                                    contact_code = dr["contact_code"].ToString(),
                                    contact_name = dr["contact_name"].ToString(),
                                    first_name = dr["first_name"].ToString(),
                                    last_name = dr["last_name"].ToString(),
                                    position = dr["position"].ToString(),
                                    tel1 = dr["tel1"].ToString(),
                                    tel2 = dr["tel2"].ToString(),
                                    cellolar = dr["cellolar"].ToString(),
                                    fax = dr["fax"].ToString(),
                                    e_maiL = dr["e_maiL"].ToString(),
                                    notes1 = dr["notes1"].ToString(),
                                    notes2 = dr["notes2"].ToString(),
                                    active = dr["active"].ToString(),
                                    //isdefault = dr["default"].ToString(),
                                    currentLine = dr["line"].ToString(),
                                    company_value = company_value
                                });
                            ...
                            {
                                ResultError.Add(dr["bp_code"].ToString() + " : " + ex.Message);
                            }
                            cnt++;
                            //}
                        }
                        ...
                        foreach (System.Data.DataRow dr in PostData.Rows)
                        {
                            ...
                            try
                            {
                                string docNum = CreateUpdateBusinessAddress(new
                                {
                                    ...
                                    currentLine = dr["line"].ToString(),
                                    status = dr["status"].ToString(),
                                    addresses_name = dr["addresses_name"].ToString(),
                                    company_value = company_value
                                });
        ...
        /// <summary>
        /// CM Create Update Business Parnert With Holding Tax
        /// </summary>
        /// <returns></returns>
        [HttpPost]
        [Route("api/cm/createupdatebusinesspartnerwithholdingtax")]
        [AllowAnonymous]
        public object CMCreateUpdateBusinessPartnerWithHoldingTax(dynamic Data)
        {
            MySqlConnection conn = new MySqlConnection(mySQLConn);
            conn.Open();
            List<string> ResultError = new List<string>();
            ...
            string refid = "";
            if (!string.IsNullOrEmpty((string)Data.business_code))
            {
                refid = (string)Data.business_code;
            }
            else
            {
                //throw new Exception( "docno is require" );
                return new { status = false, message = "error", result = "business_code code is require" };
            }
            string company_value = "";
            if (!string.IsNullOrEmpty((string)Data.company_value))
            {
            ...
            try
            {
                string sql = GetSqlCMHeader(refid, "bp_wt", "business_code", company_value);
                MySqlDataAdapter da = default(MySqlDataAdapter);
                System.Data.DataTable PostData = new System.Data.DataTable();
                da = new MySqlDataAdapter(sql, conn);
                da.Fill(PostData);
                ...
                if (PostData.Rows.Count > 0)
                {
                    ...
                    try
                    {
                        ...
                        foreach (System.Data.DataRow dr in PostData.Rows)
                        {
                            ...
                            try
                            {
                                string docNum = CreateUpdateBusinessPartnerWithHoldingTax(new
                                {
                                    business_code = dr["business_code"].ToString(),
                                    wt_code = dr["wt_code"].ToString(),
                                    isdefault = dr["def"].ToString(),
                                    company_value = company_value
                                });
                            ...
                            {
                                ResultError.Add(dr["business_code"].ToString() + " : " + ex.Message);
                            }
                            cnt++;
                            //}
                        }
        ...
        public object CMCreateUpdateHouseBankAccounts(dynamic Data)
        {
            ...
            string refid = "";
            if (!string.IsNullOrEmpty((string)Data.account_code))
            {
                refid = (string)Data.account_code;
            }
            else
            {
                //throw new Exception( "docno is require" );
                return new { status = false, message = "error", result = "account code is require" };
            }
            string company_value = "";
            if (!string.IsNullOrEmpty((string)Data.company_value))
            {
            ...
            try
            {
                string sql = GetSqlCMHeader(refid, "a_bank", "account_code", company_value);
                MySqlDataAdapter da = default(MySqlDataAdapter);
                System.Data.DataTable PostData = new System.Data.DataTable();
                da = new MySqlDataAdapter(sql, conn);
                da.Fill(PostData);
                    ...
                    try
                    {
                        ...
                        foreach (System.Data.DataRow dr in PostData.Rows)
                        {
                            if (cnt == 0)
                            {
                                try
                                {
                                    string docNum = CreateUpdateHouseBankAccount(new
                                    {
                                        code_bank = dr["code_bank"].ToString(),
                                        bank_country = dr["bank_country"].ToString(),
                                        bank_branch = dr["bank_branch"].ToString(),
                                        account_code = dr["account_code"].ToString(),
                                        account_name = dr["account_name"].ToString(),
                                        acoount_gl = dr["acoount_gl"].ToString(),
                                        company_value = company_value
                                    });
                                ...
                                {
                                    ResultError.Add(dr["account_code"].ToString() + " : " + ex.Message);
                                }
                                cnt++;
                            }
                        }
...
SELECT * FROM {TableName}";
        ...
        private string GetSqlCMDetail(string RefID, string TableName = "grcd", string RefName = "poi_ref", string CompanyValue = "")
        {
            string sql = $@"
SELECT * FROM {TableName}";
...
order by company_value";
        ...
        private string CreateCMGoodReceiptPO(dynamic Data)
        {
            ...
            SAP_Interface_Log Log = ICON.Interface.Transaction.CreateSAPLog(
                    "GoodReceiptPO_CM",
                    methodName,
                    po_reccode + "_" + (string)Data.company_value,
                    refDescription,
                    DocEntry,
                    "OPDN.DocEntry",
            ...
            try
            {
                string sql = GetSqlCMDetail(po_reccode, isService ? "sc_d" : "grcd", "poi_ref", (string)Data.company_value);
                MySqlDataAdapter da = default(MySqlDataAdapter);
                ...
                ICON.SAP.API.SAPB1.Document Doc = new ICON.SAP.API.SAPB1.Document
                {
                    ...
                    U_ICON_CMAtth = (string)Data.attachmentfile,
                    ...
                    DiscPrcnt = (string)Data.disprcnt,
                    Rounding = (string)Data.rounding,
                    RoundDif = (string)Data.rounddif,
        ...
        private string CreateGoodsReturnCM(dynamic Data)
        {
            ...
            try
            {
                string sql = GetSqlCMDetail(po_reccode, "grtd", "poi_ref", (string)Data.company_value);
                MySqlDataAdapter da = default(MySqlDataAdapter);
        ...
        private string CreateCMGoodsReceipt(dynamic Data)
        {
            ...
            try
            {
                string sql = GetSqlCMDetail(po_reccode, "grcd", "poi_ref", (string)Data.company_value);
                MySqlDataAdapter da = default(MySqlDataAdapter);
                System.Data.DataTable dt = new System.Data.DataTable();
                da = new MySqlDataAdapter(sql, conn);
                da.Fill(dt);
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    Doc.Lines.Add(new ICON.SAP.API.SAPB1.DocumentLine
                    {
                        ...
                        UnitPrice = dr["poi_priceunit"].ToString(),
                        WhsCode = dr["ic_warehouse"].ToString(),
                        ProjectCode = string.IsNullOrEmpty(dr["project_code"].ToString()) ? dr["ic_warehouse"].ToString() : dr["project_code"].ToString(),
        ...
        /****create****/
        private string CreateCMInventoryTransfer(dynamic Data)
        {
            string transfer_code = (string)Data.transfer_code;
            string methodName = "CMCreateInventoryTransfer";
            string refDescription = "tr_h.transfer_code";
            string dbName = "";
            string series = "";
            if (!string.IsNullOrEmpty((string)Data.methodName))
            {
            ...
            List<SAP_Interface_Log_Detail> LogDetail = new List<SAP_Interface_Log_Detail>();
            SAP_Interface_Log Log = ICON.Interface.Transaction.CreateSAPLog(
                    "InventoryTransfer_CM",
                    methodName,
                    transfer_code + "_" + (string)Data.company_value,
                    refDescription,
                    DocEntry,
                    "OIGN.DocEntry",
                    Newtonsoft.Json.JsonConvert.SerializeObject(Data),
            ...
            try
            {
                string sql = GetSqlCMDetail(transfer_code, "tr_d", "ref_codetransfer", (string)Data.company_value);
                MySqlDataAdapter da = default(MySqlDataAdapter);
                System.Data.DataTable dt = new System.Data.DataTable();
                da = new MySqlDataAdapter(sql, conn);
                da.Fill(dt);
                ...
                DateTime PostingDate = (DateTime)Data.docdate;
                string PostingDateString = PostingDate.ToString("yyyy-MM");
                ICON.SAP.API.SAPB1 SAPB1 = oSAPB1(dbName);
                series = SAPB1.GetSeries("67", PostingDateString, "");
                ICON.SAP.API.SAPB1.StockTransfer Doc = new ICON.SAP.API.SAPB1.StockTransfer
                {
                    DocDate = (DateTime)Data.docdate,
                    DueDate = (DateTime)Data.duedate,
                    TaxDate = (DateTime)Data.taxdate,
                    Filler = (string)Data.wh_from,
                    ToWhsCode = (string)Data.wh_to,
                    Comments = (string)Data.remark,
                    JrnlMemo = (string)Data.address_transfer,
                    Series = series
                };
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    Doc.Details.Add(new ICON.SAP.API.SAPB1.StockTransfer_Detail
                    {
                        ItemCode = dr["mat_code"].ToString(),
                        FromWhsCod = dr["fromwh"].ToString(),
                        WhsCode = dr["towh"].ToString(),
                        Quantity = dr["qty"].ToString(),
                        UnitMsr = dr["unit"].ToString(),
                        Project = string.IsNullOrEmpty(dr["project_code"].ToString()) ? "" : dr["project_code"].ToString(),
                        OcrCode = string.IsNullOrEmpty(dr["ocrcode"].ToString()) ? "" : dr["ocrcode"].ToString(),
                        OcrCode2 = string.IsNullOrEmpty(dr["ocrcode2"].ToString()) ? "" : dr["ocrcode2"].ToString(),
                        OcrCode3 = string.IsNullOrEmpty(dr["ocrcode3"].ToString()) ? "" : dr["ocrcode3"].ToString(),
                        OcrCode4 = string.IsNullOrEmpty(dr["ocrcode4"].ToString()) ? "" : dr["ocrcode4"].ToString(),
                ...
                try
                {
                    SAPB1.CreateStockTransfer(Doc, out SAPStatusCode, out SAPErrorMessage, out DocNum);
                    SAPStatus = SAPStatusCode.ToString();
                }
                catch (Exception ex)
                {
        ...
        /****cancel****/
        private string CancelCMInventoryTransfer(dynamic Data)
        {
            string po_reccode = (string)Data.po_reccode;
            string methodName = "CMCancelInventoryTransfer";
            string refDescription = "grch.po_reccode";
            string project_code = "";
            string dbName = "";
            string sap_receive_code = "";
        ...
        private string CreateGoodsIssueCM(dynamic Data)
        {
            ...
            SAP_Interface_Log Log = ICON.Interface.Transaction.CreateSAPLog(
                "GoodsIssue_CM",
                "CreateGoodsIssueCM",
                Is_Doccode + "_" + (string)Data.company_value,
                "gih.is_doccode",
                DocEntry,
                "OIGE.DocEntry",
                Newtonsoft.Json.JsonConvert.SerializeObject(Data),
            ...
            try
            {
                string sql = GetSqlCMDetail(Is_Doccode, "gid", "isi_doccode", (string)Data.company_value);
                MySqlDataAdapter da = default(MySqlDataAdapter);
                System.Data.DataTable dt = new DataTable();
                da = new MySqlDataAdapter(sql, conn);
                da.Fill(dt);
        ...
        private string CreateJournalVoucher(dynamic Data)
        {
            ...
            SAP_Interface_Log Log = ICON.Interface.Transaction.CreateSAPLog(
                    "JournalVoucher_CM",
                    methodName,
                    docNo + "_" + (string)Data.company_value,
                    refDescription,
                    null,
                    "BOTF.BatchNum",
                    Newtonsoft.Json.JsonConvert.SerializeObject(Data),
            ...
            try
            {
                string sql = GetSqlCMDetail(docNo, "pcadvd", "pettycashi_ref", (string)Data.company_value);
                MySqlDataAdapter da = default(MySqlDataAdapter);
                System.Data.DataTable dt = new System.Data.DataTable();
                da = new MySqlDataAdapter(sql, conn);
                da.Fill(dt);
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    Doc.Lines.Add(new ICON.SAP.API.SAPB1.DocumentLine
                    {
                        ...
                        U_ICON_PT = dr["phase_name"].ToString(),
                        U_ICON_BF = dr["block_name"].ToString(),
                        U_BPBRANCH = string.IsNullOrEmpty(dr["branch"].ToString()) ? "" : dr["branch"].ToString(),
                    });
                    ...
                    if (Convert.ToDouble(dr["CR_WT_Amt"]) > 0)
                    {
                        Doc.Lines.Add(new ICON.SAP.API.SAPB1.DocumentLine
                        {
                            ...
                            TAX_BASE = dr["pettycashi_unitprice"].ToString(),
                            TAX_NO = string.IsNullOrEmpty(dr["utaxno"].ToString()) ? "" : dr["utaxno"].ToString(),
                            TAX_REFNO = dr["pettycashi_invno"].ToString(),
                            TAX_PECL = Doc.PostingDate.ToString("yyyy-MM"),
                            TAX_TYPE = dr["tax_type"].ToString(),
                            TAX_BOOKNO = string.IsNullOrEmpty(dr["utaxbookno"].ToString()) ? "" : dr["utaxbookno"].ToString(),
                            TAX_CARDNAME = u_tax_cardname,
                            TAX_ADDRESS = dr["pettycashi_addrvender"].ToString(),
                            TAX_TAXID = (string)Data.vender_tax,
                            TAX_DATE = Convert.ToDateTime(dr["pettycashi_paydate"]),
                            TAX_CODE = dr["WTax_Code"].ToString(),
                            TAX_CODENAME = dr["name_wt"].ToString(),
                            TAX_RATE = dr["per_wt"].ToString(),
                            TAX_DEDUCT = string.IsNullOrEmpty(dr["tax_deduct"].ToString()) ? "1" : dr["tax_deduct"].ToString(),
        ...
        private string SendGVAllocate(dynamic Data)
        {
            ...
            try
            {
                string sql = GetSqlCMDetail(docNo, "pas_d", "Transld", (string)Data.company_value);
                MySqlDataAdapter da = default(MySqlDataAdapter);
                System.Data.DataTable dt = new System.Data.DataTable();
                da = new MySqlDataAdapter(sql, conn);
                da.Fill(dt);
        ...
        private string CreateUpdateCostCenter(dynamic Data)
        {
            ...
            try
            {
                ...
                ICON.SAP.API.SAPB1.CostCenter ObjSave = new SAPB1.CostCenter
                {
                    ...
                    ValidFrom = Convert.ToDateTime(Data.valid_from),
                    ValidTo = Convert.ToDateTime(Data.valid_to),
        ...
        private string CreateUpdateProject(dynamic Data)
        {
            ...
            try
            {
                ...
                ICON.SAP.API.SAPB1.Project Pro = new SAPB1.Project
                {
                    ...
                    ValidFrom = Convert.ToDateTime(Data.project_start),
                    ValidTo = Convert.ToDateTime(Data.project_stop),
        ...
        private string CreateUpdatePaymentTerms(dynamic Data)
        {
            ...
            try
            {
                ...
                {
                    GroupNum = Convert.ToInt32(Data.sap_code),
                ...
                try
                {
                    SAPB1.CreateUpdatePaymentTermsMaster(ObjSave, out SAPStatusCode, out SAPErrorMessage, out DocNum);
                    SAPStatus = SAPStatusCode.ToString();
                }
                catch (Exception ex)
                {
        ...
        private string CreateUpdateWarehouse(dynamic Data)
        {
            ...
            try
            {
                ...
                ICON.SAP.API.SAPB1.Warehouse Whs = new SAPB1.Warehouse
                {
                    ...
                    BalInvntAc = string.IsNullOrEmpty((string)Data.acct_inventoty) ? "" : (string)Data.acct_inventoty,
                    SaleCostAc = string.IsNullOrEmpty((string)Data.acct_cost_of_good_sold) ? "" : (string)Data.acct_cost_of_good_sold,
                    TransferAc = string.IsNullOrEmpty((string)Data.acct_allocation) ? "" : (string)Data.acct_allocation,
                    PriceDifAc = string.IsNullOrEmpty((string)Data.acct_price_dif) ? "" : (string)Data.acct_price_dif,
                    ExpensesAC = string.IsNullOrEmpty((string)Data.acct_expense) ? "" : (string)Data.acct_expense,
                    APCMAct = string.IsNullOrEmpty((string)Data.acct_purchase_credit) ? "" : (string)Data.acct_purchase_credit,
                    RevenuesAc = string.IsNullOrEmpty((string)Data.acct_revenue) ? "" : (string)Data.acct_revenue,
                    ARCMAct = string.IsNullOrEmpty((string)Data.acct_sales_credit) ? "" : (string)Data.acct_sales_credit,
                    IncresGlAc = string.IsNullOrEmpty((string)Data.acct_increase) ? "" : (string)Data.acct_increase,
                    DecresGlAc = string.IsNullOrEmpty((string)Data.acct_decrease) ? "" : (string)Data.acct_decrease
        ...
        private string CreateUpdateItemMaster(dynamic Data)
        {
            ...
            try
            {
                ...
                ICON.SAP.API.SAPB1.ItemMaster ObjSave = new SAPB1.ItemMaster
                {
                    ...
                    VatGroupPu = string.IsNullOrEmpty((string)Data.vat_gourp_pu) ? "" : (string)Data.vat_gourp_pu,
                    VatGourpSa = string.IsNullOrEmpty((string)Data.sales_tax) ? "" : (string)Data.sales_tax,
                    ...
                    GLMethod = string.IsNullOrEmpty((string)Data.gl_method) || (string)Data.gl_method.ToUpper() == "C" ? SAPbobsCOM.BoGLMethods.glm_ItemClass : (string)Data.gl_method.ToUpper() == "W" ? SAPbobsCOM.BoGLMethods.glm_WH : (string)Data.gl_method.ToUpper() == "L" ? SAPbobsCOM.BoGLMethods.glm_ItemLevel : SAPbobsCOM.BoGLMethods.glm_ItemClass,
                    ...
                    EvalSystem = string.IsNullOrEmpty((string)Data.eval_system) || (string)Data.eval_system.ToUpper() == "M" ? SAPbobsCOM.BoInventorySystem.bis_MovingAverage : (string)Data.eval_system.ToUpper() == "S" ? SAPbobsCOM.BoInventorySystem.bis_Standard : (string)Data.eval_system.ToUpper() == "F" ? SAPbobsCOM.BoInventorySystem.bis_FIFO : (string)Data.eval_system.ToUpper() == "B" ? SAPbobsCOM.BoInventorySystem.bis_SNB : SAPbobsCOM.BoInventorySystem.bis_MovingAverage,
        ...
        #region #### Create Update Item To Warehouse #####
        private string CreateUpdateItemToWarehose(dynamic Data)
        {
            string docNo = (string)Data.item_code;
            string methodName = "CMCreateUpdateItemToWarehose";
            string refDescription = "item_wh";
            string dbName = (string)Data.company_value;
            ...
            try
            {
                ...
                ICON.SAP.API.SAPB1 SAPB1 = oSAPB1(dbName);
                ICON.SAP.API.SAPB1.ItemToWarehouse ObjSave = new SAPB1.ItemToWarehouse
                {
                    ItemCode = (string)Data.item_code,
                    WhsCode = (string)Data.wh_code,
                    Locked = string.IsNullOrEmpty((string)Data.locked) || (string)Data.locked.ToUpper() == "N" ? SAPbobsCOM.BoYesNoEnum.tNO : SAPbobsCOM.BoYesNoEnum.tYES,
                    BalInvntAc = string.IsNullOrEmpty((string)Data.acct_inventoty) ? "" :(string)Data.acct_inventoty,
                    SaleCostAc = string.IsNullOrEmpty((string)Data.acct_cost_of_good_sold) ? "" :(string)Data.acct_cost_of_good_sold,
                    TransferAc = string.IsNullOrEmpty((string)Data.acct_allocation) ? "" :(string)Data.acct_allocation,
                    PriceDifAc = string.IsNullOrEmpty((string)Data.acct_price_dif) ? "" :(string)Data.acct_price_dif,
                ...
                try
                {
                    SAPB1.CreateUpdateItemToWarehouse(ObjSave, out SAPStatusCode, out SAPErrorMessage);
                    SAPStatus = SAPStatusCode.ToString();
                }
                catch (Exception ex)
                {
        ...
        private string CreateUpdateBusinessContactPersons(dynamic Data)
        {
            ...
            try
            {
                ...
                ICON.SAP.API.SAPB1.ContactPersons ObjSave = new SAPB1.ContactPersons
                {
                    ...
                    CardCode = (string)Data.bp_code,
                    Name = (string)Data.contact_name,
                    FirstName = (string)Data.first_name,
                    LastName = (string)Data.last_name,
                    Position = (string)Data.position,
                    Tel1 = (string)Data.tel1,
                    Tel2 = (string)Data.tel2,
                    Cellolar = (string)Data.cellolar,
                    Fax = (string)Data.fax,
                    E_MaiL = (string)Data.e_maiL,
                    Notes1 = (string)Data.notes1,
                    Notes2 = (string)Data.notes2,
                    Active = (string)Data.active,
                    //Default = (string)Data.isdefault,
                    CurrentLine = (string)Data.currentLine,
        ...
        private string CreateUpdateBusinessAddress(dynamic Data)
        {
            ...
            try
            {
                ...
                ICON.SAP.API.SAPB1.BusinessPartnerAddress ObjSave = new SAPB1.BusinessPartnerAddress
                {
                    ...
                    ZipCode = (string)Data.zip_code,
                    CurrentLine = (string)Data.currentLine,
                    Default = string.IsNullOrEmpty((string)Data.status) || (string)Data.status.ToLower() == "n" ? "N" : "Y",
                    AddressesName = (string)Data.addresses_name
                };
        ...
        #region #### Create Update Business Partner WithHoldingTax #####
        private string CreateUpdateBusinessPartnerWithHoldingTax(dynamic Data)
        {
            string docNo = (string)Data.business_code;
            string methodName = "CreateUpdateBusinessPartnerWithHoldingTax";
            string refDescription = "bp_wt";
            string dbName = (string)Data.company_value;
            ...
            List<SAP_Interface_Log_Detail> LogDetail = new List<SAP_Interface_Log_Detail>();
            SAP_Interface_Log Log = ICON.Interface.Transaction.CreateSAPLog(
                    "CreateUpdateBusinessPartnerWithHoldingTax_CM",
                    methodName,
                    docNo + "_" + (string)Data.company_value,
                    refDescription,
                    null,
            ...
            try
            {
                ...
                ICON.SAP.API.SAPB1 SAPB1 = oSAPB1(dbName);
                ICON.SAP.API.SAPB1.BusinessParnerWithHoldingTax ObjSave = new SAPB1.BusinessParnerWithHoldingTax
                {
                    CardCode = (string)Data.business_code,
                    WTCode = (string)Data.wt_code,
                    Default = (string)Data.isdefault,
                };

                try
                {
                    SAPB1.CreateUpdateBusinessPartnerWithHoldingTax(ObjSave, out SAPStatusCode, out SAPErrorMessage);
                    SAPStatus = SAPStatusCode.ToString();
                }
                catch (Exception ex)
                {
        ...
        #region #### Create Update House Bank Account ####
        private string CreateUpdateHouseBankAccount(dynamic Data)
        {
            string docNo = (string)Data.code_bank;
            string methodName = "CreateUpdateHouseBankAccount";
            string refDescription = "a_bank";
            string dbName = (string)Data.company_value;
            ...
            List<SAP_Interface_Log_Detail> LogDetail = new List<SAP_Interface_Log_Detail>();
            SAP_Interface_Log Log = ICON.Interface.Transaction.CreateSAPLog(
                    "CreateUpdateHouseBankAccount_CM",
                    methodName,
                    docNo + "_" + (string)Data.company_value,
                    refDescription,
                    null,
            ...
            try
            {
                ...
                ICON.SAP.API.SAPB1 SAPB1 = oSAPB1(dbName);
                ICON.SAP.API.SAPB1.HouseBankAccount ObjSave = new SAPB1.HouseBankAccount
                {
                    BankCode = (string)Data.code_bank,
                    Country = string.IsNullOrEmpty((string)Data.bank_country) ? "TH" : (string)Data.bank_country,
                    Branch = (string)Data.bank_branch,
                    Account = (string)Data.account_code,
                    AcctName = (string)Data.account_name,
                    GLAccount = (string)Data.acoount_gl,
                };

                try
                {
                    SAPB1.CreateUpdateHouseBankAccount(ObjSave, out SAPStatusCode, out SAPErrorMessage);
                    SAPStatus = SAPStatusCode.ToString();
                }
                catch (Exception ex)
                {
